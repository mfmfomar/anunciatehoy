...
(function (window, document, $) {
  ...
  i18next
    ...
    .init({
      ...
      fallbackLng: "es",
      backend: {
        loadPath: "/publico/app-assets/data/locales/{{lng}}.json",
      },
      returnObjects: true
    },
      function (err, t) {
        ...
        i18next.changeLanguage(localStorage.getItem('i18next'), function (err, t) {
          $("body").localize();
          if(localStorage.getItem('i18next')=='es') $(".selected-language").html('Español');
          if(localStorage.getItem('i18next')=='es') $("#banderaIcono").addClass('flag-icon-mx');
          if(localStorage.getItem('i18next')=='en') $(".selected-language").html('English');
          if(localStorage.getItem('i18next')=='en') $("#banderaIcono").addClass('flag-icon-us');
          
        });
        }else{
          localStorage.setItem('i18next', 'es');
          $(".selected-language").html('Español');
          $("#banderaIcono").addClass('flag-icon-mx');
          $("#languageDefault").click();
  ...
  $(".dropdown-language .dropdown-item").on("click", function () {
    ...
    i18next.changeLanguage(currentLanguage, function (err, t) {
      $("body").localize();
      localStorage.setItem('i18next', currentLanguage);
    });
  })
