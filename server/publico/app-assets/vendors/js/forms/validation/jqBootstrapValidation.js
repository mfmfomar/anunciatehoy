            ...
            init: function (options) {
                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("minlength_es") !== undefined) {
                            message = "Demasiado corto: mínimo de '" + $this.attr("minlength_es") + "' Caracteres<!-- data-validation-minlength-message to override -->";

                            if ($this.data("validationMinlengthMessage")) {
                                message = $this.data("validationMinlengthMessage");
                            }
                            $this.data("validationMinlengthMessage", message);
                            $this.data("validationMinlengthMinlength", $this.attr("minlength_es"));
                        }
                        // ---------------------------------------------------------
                        //                                                  REQUIRED
                        // ---------------------------------------------------------
        ...
        validatorTypes: {
            ...
            minlength_es: {
                ...
                init: function ($this, name) {
                    ...
                    result.minlength_es = $this.data("validation" + name + "minlength_es");

                    result.message = "Demasiado corto: mínimo de '" + result.minlength_es + "' caracteres";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                ...
                validate: function ($this, value, validator) {
                    return ((value.length < validator.minlength_es) && !validator.negative) ||
                        ((value.length >= validator.minlength_es) && validator.negative);
                }
            },
            maxchecked: {
                name: "maxchecked",
